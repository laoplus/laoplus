...
internal static class SkinTex
{
    ...
    public static readonly Texture2D ButtonRest  = Load("Button/Button-rest.png");
    public static readonly Texture2D ButtonHover  = Load("Button/Button-hover.png");
    public static readonly Texture2D ButtonPressed  = Load("Button/Button-pressed.png");
    ...
    // Cursor
    public static readonly Texture2D CursorResizeNs = Load("Cursor/ResizeNS.png");
