...
internal static class SkinColor
{
    ...
    static SkinColor()
    {
        ...
        ColorUtility.TryParseHtmlString("#C42B1C"  , out Light_Shell_FillColor_CaptionControlCloseFill_Primary);
        ColorUtility.TryParseHtmlString("#FFFFFF"  , out Light_Shell_FillColor_CaptionCloseText_Primary);
        ColorUtility.TryParseHtmlString("#F3F3F3"  , out Light_Background_FillColor_SolidBackground_Base);
        ColorUtility.TryParseHtmlString("#C42B1CE5", out Dark_Shell_FillColor_CaptionControlCloseFill_Secondary);
        ColorUtility.TryParseHtmlString("#FFFFFFB2", out Dark_Shell_FillColor_CaptionCloseText_Secondary);
